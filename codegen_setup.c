...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "DBFinalBout",
    .project_root_env = "DBFINALBOUTRECOMP_PROJECT_ROOT",
    .build_dir_env = "DBFINALBOUTRECOMP_BUILD_DIR",
    .force_setup_env = "DBFINALBOUTRECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_004.93_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "DBFinalBout_Recompiled",
    .prepare_note =
